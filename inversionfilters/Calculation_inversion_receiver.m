...
S_tmp = load('impuls_responses\HpTF_A1.mat');
v_HpIR =[v_HpIR S_tmp.M_HpIR_r(:,1)];

S_tmp = load('impuls_responses\HpTF_B1.mat');
v_HpIR =[v_HpIR S_tmp.M_HpIR_l(:,[1 3 4]) S_tmp.M_HpIR_r(:,[1 3 4 5])  ];

S_tmp = load('impuls_responses\HpTF_C1.mat');
v_HpIR =[v_HpIR S_tmp.M_HpIR_l(:,3) S_tmp.M_HpIR_r(:,[3 4 5])  ];

S_tmp = load('impuls_responses\HpTF_C2.mat');
v_HpIR =[v_HpIR  S_tmp.M_HpIR_r(:,5)  ];

S_tmp = load('impuls_responses\HpTF_C3.mat');
